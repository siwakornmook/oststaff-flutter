...
class EventPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: FutureBuilder(
              future: NotificationService().getView(requestId: requestId),
  ...
  Widget _buildAttachment({View item, context}) {
    return GestureDetector(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ViewAttachmentPage(item.fileAttach)),
        );
      },
    );
  }
